...
@section('title', 'Edit Course - Student Information System')
...
<div class="card" style="max-width: 600px;">
    <form action="{{ route('courses.update', $course->course_id) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="number" id="units" name="units" value="{{ old('units', $course->units) }}" min="1" max="12" required>
        ...
        <div class="form-group">
            ...
            <select id="department_id" name="department_id" required>
                ...
                @foreach ($departments as $department)
                    <option value="{{ $department->department_id }}" {{ old('department_id', $course->department_id) == $department->department_id ? 'selected' : '' }}>
